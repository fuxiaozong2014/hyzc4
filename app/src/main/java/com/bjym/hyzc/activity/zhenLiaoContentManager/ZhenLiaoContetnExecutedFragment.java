 ...
 */
public class ZhenLiaoContetnExecutedFragment extends BaseFragment {
        ...
        OkHttpUtils.get()
                ...
                .execute(new Callback() {
                    ...
                    public Object parseNetworkResponse(Response response, int i) throws Exception {
                       // MyToast.showToast(ZhenLiaoContetnExecutedFragment.this.getActivity(), response.body().string());
                    ...
                    public void onResponse(Object o, int i) {
                        //MyToast.showToast(ZhenLiaoContetnExecutedFragment.this.getActivity(), (String) o);
                        parseJson((String) o);
                    }
                });
